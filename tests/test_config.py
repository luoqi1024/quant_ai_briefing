...
def test_validate_settings_accepts_generic_ai_config():
    settings = Settings(
    ...
    validate_settings(settings, dry_run=False, send=False)


def test_validate_settings_accepts_legacy_xiaomi_ai_config():
    settings = Settings(
        database_path="test.db",
